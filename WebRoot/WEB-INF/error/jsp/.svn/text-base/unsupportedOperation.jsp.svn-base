...
A generic system error page. Displayed after an SystemException
has been thrown.
###################################################################################
--%>
...
<%-- Error page title --%>
<p/>
<h1><bean:message key="error.unsupportedOperation.title" /></h1>
...
<bean:message key="error.unsupportedOperation.description" />
<p/>
<bean:message key="error.systemError.returntomainpage" />
<html:link module="" page="">
	<bean:message key="user.home.link" />
</html:link>
<bean:message key="error.systemError.usebackbutton" />
<p/>
