...
Children editing form for an item whose children comparator is of type SERIAL_NO
(SNComparator), that is, they are sorted by their serial number rather by their
names.
...
<table border="0" cellspacing="5" id="children_SERIAL_NO">
	...
	<logic:iterate name="editItemFullForm" scope="request"
		...
		<tr valign="top">
			<logic:equal name="childrenForms" property="readOnly" value="true">
				...
				<td align="left">
					<bean:write name="childrenForms" scope="page" property="serialNo" />.
				</td>
				<td>
	...
	<tr>
		<td>
			<logic:equal name="editItemFullForm" property="newChildForm.serialNo" value="${Names_MISC_INVALID_VALUE_INTEGER}">
				<html:text name="editItemFullForm" property="newChildForm.serialNo" size="1" value="" />.
			</logic:equal>
			<logic:notEqual name="editItemFullForm" property="newChildForm.serialNo" value="${Names_MISC_INVALID_VALUE_INTEGER}">
				<html:text name="editItemFullForm" property="newChildForm.serialNo" size="1" />.
			</logic:notEqual>
			<%--
