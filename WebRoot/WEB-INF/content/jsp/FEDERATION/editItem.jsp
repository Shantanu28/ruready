...
Federation-type Item custom editing form. This is not a full HTML page and included in
...
<tbody>
	...
	<tr valign="top">
		<td>
			<bean:message key="content.FEDERATION.phoneCode.label" />
		</td>
		<td>
			<nested:text property="phoneCode" size="20" />
			<content:conflict localEntity="${item.phoneCode}" storedEntity="${storedItem.phoneCode}" />
		</td>
	</tr>
