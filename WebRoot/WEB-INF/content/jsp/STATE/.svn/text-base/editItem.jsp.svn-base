...
A generic Item editing form. This is not a full HTML page and included in
other edit pages inside an <html:form> tag inside the proper nesting.
...
<tbody>
	...
	<%-- Display a textbox for the comment --%>
	<tr valign="top">
		<td>
	...
	<tr valign="top">
		<td>
			<bean:message key="content.STATE.abbreviation.label" />
		</td>
		<td>
			<nested:text property="abbreviation" size="5" />
