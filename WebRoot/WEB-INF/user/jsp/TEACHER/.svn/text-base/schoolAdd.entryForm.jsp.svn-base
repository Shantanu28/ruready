...
<html:form method="post">
	...
	<div id="entryForm">
		...
		<%-- School search field --%>
		<div>
			<label for="searchString"><bean:message key="${fieldPrefix}.SCHOOL.label"/>:</label>
			<span>
		...
		<div class="formControls">
			...
			<html:submit property="_eventId_schoolRequest" styleClass="edit">
				<bean:message key="${pagePrefix}.button.schoolRequest" />
			</html:submit>
		</div>
	</div>	
</html:form>