...
<html:xhtml />
<c:set var="pagePrefix" value="user.studentSchoolMemberships.view"/>
...
<div id="tableContent">
	...
	<div class="formControls">
		<ul>
			<li>
				<html:link action="/open/STUDENT/schools/add">
	...
	<div class="clear"></div>
	<c:choose>
		<c:when test="${empty viewBean.schools}">
		...
		<c:otherwise>
			<div class="data">
				<table cellspacing="0">
					...
					<tbody>
						<c:forEach var="school" items="${viewBean.schools}">
							<tr>
								<td class="link">
									<html:link action="/open/STUDENT/schools/delete" paramId="schoolId" paramName="school" paramProperty="id">
