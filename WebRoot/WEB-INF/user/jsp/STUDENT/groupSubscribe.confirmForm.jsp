...
<html:form method="post">
	...
	<div id="entryForm">
		...
		<div class="headerInfo">
			<table cellspacing="0">
				<caption><bean:message key="${pagePrefix}.unsubscribeGroup.header"/></caption>
				<tr>
					<th><bean:message key="${fieldPrefix}.NAME.label"/></th>
					<td>${currentFormObject.conflictingGroup.name}</td>
				</tr>
				<tr>
					<th><bean:message key="${fieldPrefix}.SCHOOL.label"/></th>
					<td>${currentFormObject.conflictingGroup.school.description}</td>
				</tr>
				<tr>
					<th><bean:message key="${fieldPrefix}.COURSE.label"/></th>
					<td>${currentFormObject.conflictingGroup.course.description}</td>
				</tr>
			</table>
		</div>
		<div class="headerInfo">
			<table cellspacing="0">
				<caption><bean:message key="${pagePrefix}.subscribeGroup.header"/></caption>
				<tr>
					<th><bean:message key="${fieldPrefix}.NAME.label"/></th>
