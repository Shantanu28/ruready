...
<html:form method="post">
	...
	<div id="entryForm">
		...
		<div>
			...
			<span>
				<html:text styleId="searchString" property="search.searchString" size="45"/>
			</span>
		</div>
		<div>
			<label for="schoolFilter">&nbsp;</label>
			<span>
				<input type="hidden" name="_search.schoolFilter"/>
				<html:checkbox property="search.schoolFilter" styleId="schoolFilter">
