...
<html:form>
	...
	<html:hidden property="schoolId" styleId="schoolId"/>
	...
	<div id="entryForm">
		...
		<div>
			...
			<span class="schoolSearch">
				<span id="schoolSearchMatch" style="display:none;"><a href=""><bean:message key="${pagePrefix}.SCHOOL_REMOVE.label"/></a> <em></em></span>
