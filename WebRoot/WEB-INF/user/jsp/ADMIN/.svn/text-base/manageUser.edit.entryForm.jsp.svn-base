...
<html:form method="post">
	...
	<div id="entryForm">
		...
		<%-- First Name --%>
		<div>
			<label for="firstName"><bean:message key="${fieldPrefix}.FIRST_NAME.label"/><common:required/>:</label>
			<span>
		...
		<%-- Last Name --%>
		<div>
			<label for="lastName"><bean:message key="${fieldPrefix}.LAST_NAME.label"/><common:required/>:</label>
			<span>
