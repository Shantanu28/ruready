...
<html:xhtml />
<c:set var="pagePrefix" value="user.userSearch.view.criteriaForm"/>
...
<html:form>
	...
	<div id="entryForm">
		...
		<div>
			...
			<ul class="optionList">
			<c:forEach var="fieldName" items="${currentFormObject.criteriaOptions.searchableFieldNameOptions}">
				<li><html:radio property="selectedFieldName" value="${fieldName.value}">${fieldName.label}</html:radio></li>
			</c:forEach>
			</ul>
		</div>
