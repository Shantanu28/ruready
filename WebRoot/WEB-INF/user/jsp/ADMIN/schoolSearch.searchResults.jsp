			...
			<div class="data">
				...
				<table cellspacing="0">
					...
					<thead>
						<tr>
							<th class="link"></th>
							<th><bean:message key="${pagePrefix}.SCHOOL.label"/></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="school" items="${results}">
							<tr>
								<td class="link">
									<html:link href="?_flowExecutionKey=${flowExecutionKey}&_eventId_students&schoolId=${school.id}">
										<bean:message key="${pagePrefix}.students.altText"/>
									</html:link>
									<html:link href="?_flowExecutionKey=${flowExecutionKey}&_eventId_teachers&schoolId=${school.id}">
										<bean:message key="${pagePrefix}.teachers.altText"/>
									</html:link>
								</td>
