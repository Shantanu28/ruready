/*****************************************************************************************
 * Source File: FindOrCreateItemFilter.java
 ****************************************************************************************/
 ...
 * <code>CommonNames.MISC.INVALID_VALUE_INTEGER</code>, and 2 failed. We
 * instantiate an a new (blank) item of this type. This is case used by actions
 * that add new items to the database.<br>
 * <p>
 ...
 * @version Jul 28, 2007
 */
public class FindOrCreateItemFilter extends FilterAction
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(FindOrCreateItemFilter.class);
	 ...
	 */
	public FindOrCreateItemFilter(FilterDefinition filterDefinition)
	{
			...
			final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		Item item = bdItemUtil.findOrCreateItem(itemId, itemType, parentId);
	...
	{
		return "Find or create a new Item";
	}
