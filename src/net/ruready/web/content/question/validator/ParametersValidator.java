...
/**
 * A validation rule for parameter maps that feed the parametric evaluation parser. Used
 * in question editing.
 * <p>
 * -------------------------------------------------------------------------<br>
...
public class ParametersValidator implements CustomValidator
{
	// ========================= CONSTANTS =================================
			...
			ActionMessages errors, Validator validator, HttpServletRequest request)
	{
		...
		// Validate value to be a parameter map string representation
		...
		logger.debug("Successfully Parsed form bean field '" + value
				+ "' into parameter range map: " + paramRanges);
		if (!valid)
		{
