...
public class RunDDLFixer
{
	...
	private static final Log logger = LogFactory.getLog(RunDDLFixer.class);
	...
	public static void main(String[] args)
	{
		...
		DDLFileFixer t = new DDLFileFixer(args[0], args[1], args[2]);
		t.run();
