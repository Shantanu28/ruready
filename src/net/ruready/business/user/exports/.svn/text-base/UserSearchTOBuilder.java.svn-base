...
public class UserSearchTOBuilder extends UserTOBuilder
{
	...
	public UserSearchTOBuilder(final MessageResources messageResources)
	{
	...
	private <E extends Enum<E>> Map<E, String> getMap(final Class<E> clazz, final MessageResources messageResources)
	{
