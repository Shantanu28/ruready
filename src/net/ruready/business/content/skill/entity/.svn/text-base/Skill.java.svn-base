...
/**
 * A catalog item representing a skill in a certain subject (e.g. solving quadratic
 * equations in the subject of mathematics).
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class Skill extends TagItem
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public Skill(String name, String comment)
	{
		super(name, comment);
	}
	 ...
	 *            tag to copy from
	 */
	public Skill(final Skill other)
	{
		super(other);
	}
