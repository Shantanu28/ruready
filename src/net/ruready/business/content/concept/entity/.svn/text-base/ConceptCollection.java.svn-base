...
/**
 * The root of the concept hierarchy in the content management system.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class ConceptCollection extends MainTagItem
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(ConceptCollection.class);
	 ...
	 */
	public ConceptCollection(String name, String comment)
	{
		super(name, comment);
	}
	...
	{
		return ItemType.CONCEPT_COLLECTION;
	}
