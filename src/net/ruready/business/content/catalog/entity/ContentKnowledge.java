...
/**
 * A catalog item representing a specific content type in a course that contains the
 * course's substance (knowledge).
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class ContentKnowledge extends ContentType
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public ContentKnowledge(String name, String comment)
	{
		super(name, comment);
	}
	...
	{
		return ItemType.CONTENT_KNOWLEDGE;
	}
