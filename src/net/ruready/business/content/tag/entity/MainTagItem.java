...
/**
 * An abstraction for the main folders under the {@link TagCabinet} object.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public abstract class MainTagItem extends TagItem
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public MainTagItem(String name, String comment)
	{
		super(name, comment);
	}
