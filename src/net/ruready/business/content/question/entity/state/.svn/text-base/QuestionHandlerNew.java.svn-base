...
/**
 * The state of a newly created question.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
class QuestionHandlerNew extends QuestionHandlerStub
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(QuestionHandlerNew.class);
