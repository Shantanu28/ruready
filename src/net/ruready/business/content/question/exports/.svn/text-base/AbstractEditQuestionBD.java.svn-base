/*****************************************************************************************
 * Source File: AbstractEditQuestionBD.java
 ****************************************************************************************/
...
/**
 * An abstraction of the business delegate handling question operations.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Aug 12, 2007
 */
public interface AbstractEditQuestionBD extends BusinessDelegate,
		AbstractEditItemBD<Question>, AbstractEditQuestionManager
