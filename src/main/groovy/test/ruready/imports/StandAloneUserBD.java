 ...
 * @version Oct 2, 2007
 */
public class StandAloneUserBD extends DefaultUserBD
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(StandAloneUserBD.class);
	 ...
	 */
	public StandAloneUserBD(final ApplicationContext context)
	{
		super(new DefaultUserManager(TestResourceLocator.getInstance(), context),
