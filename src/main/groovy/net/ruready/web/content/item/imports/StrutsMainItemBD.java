 ...
 * @version Aug 11, 2007
 */
public class StrutsMainItemBD extends DefaultMainItemBD
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(StrutsMainItemBD.class);
	 ...
	 */
	public StrutsMainItemBD(final ApplicationContext context, final User user)
	{
		super(new DefaultMainItemManager(WebAppResourceLocator.getInstance(), context,
