 ...
 *        <p>
 *        version 1.1 - optimise using text.indexOf('&amp;') and
 *        sb.append(string) rather than processing character by character.
 *        <p>
 *        version 1.2 2004-07-21 - add stripHTMLTags - stripFile also strips
 *        tags - add stripNbsp
 *        <p>
 *        version 1.3 2005-06-20 - fix bug in possEntityToChar - exposed
 *        possEntityToChar as public
 *        <p>
 *        Version 1.4 2005-07-02 - check for null input
 *        <p>
 *        Version 1.5 2005-07-29 - no longer needs entitiestochar.ser file.
 *        Converted to JDK 1.5 back to 1,2 Version 1.6 2005-09-05 - faster code
 *        for stripHTMLTags that returns original string if nothing changed.
...
class StripEntities
{
	...
	private static final Log logger = LogFactory.getLog(StripEntities.class);
	...
	public static String stripEntities(String text)
	{
		...
		for (int i = 0; i < originalTextLength; i++)
		{
			...
			else
			{
				...
				String possEntity = text.substring(i + 1, Math.min(i + LONGEST_ENTITY,
						text.length()));
	 ...
	 */
	public static String stripHTMLTags(final String html0)
	{
		String html = html0.trim();
		...
		return (cleanedAnyWhitespace || result.length() != numChars) ? result.toString()
				.trim() : html;
	}
	...
	public static void main(String[] args)
	{
		if (DEBUGGING)
		{
			logger.info(stripEntities(" Bed &amp; Breakfast "));
			logger.info(stripHTMLTags(" <a href=\"ibm.html\">big blue</a> "));
			logger.info(stripHTMLTags("<a href=\"ibm.html\">big\nblue</a>"));
			logger.info(stripHTMLTags("big\nblue"));
			logger.info(stripHTMLTags("big blue"));
		}
	}
} // end StripEntitiesz
