/*****************************************************************************************
 * Source File: WorldDataParser_1_3.java
 ****************************************************************************************/
 ...
 * @version Sep 8, 2007
 */
public class WorldDataParser_1_3 extends XmlParser
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(WorldDataParser_1_3.class);
	...
	protected Hashtable<String, Helper> helpers()
	{
		...
		helpers.put("city", new StringElementHelper("city"));
