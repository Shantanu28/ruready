...
/**
 * A catalog item representing an expectation cateogyr such as Thinking Skills in a
 * course's expectation set.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class ExpectationCategory extends Item
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	protected ExpectationCategory()
	{
		super();
	}

	/**
	 * Create an expectation category with a name and comment.
	 * 
	 * @param name
	 *            course name
	 * @param comment
	 *            course comment
	 */
	public ExpectationCategory(String name, String comment)
	{
		super(name, comment);
	}
	...
	{
		return ItemType.EXPECTATION_CATEGORY;
	}
