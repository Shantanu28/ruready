...
/**
 * A catalog item representing the expectations' content type in a course.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class ExpectationSet extends ContentType
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public ExpectationSet(String name, String comment)
	{
		super(name, comment);
	}
	...
	{
		return ItemType.EXPECTATION_SET;
	}
