 ...
 ****************************************************************************************/
package net.ruready.business.content.skill.entity;
...
/**
 * The root of the skill hierarchy in the content management system.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class SkillCollection extends MainTagItem
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(SkillCollection.class);
	 ...
	 */
	public SkillCollection(String name, String comment)
	{
		super(name, comment);
	}
	...
	/**
	 * This is a tag folder, it doesn't have a parent tag folder so this method returns
	 * <code>null</code>.
	 * 
	 * @return
	...
	{
		return ItemType.SKILL_COLLECTION;
	}
