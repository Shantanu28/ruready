...
/**
 * The state of an active question that is not new.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
class QuestionHandlerActive extends QuestionHandlerStub
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(QuestionHandlerActive.class);
	 ...
	 */
	protected QuestionHandlerActive()
	{
		super();
	}
