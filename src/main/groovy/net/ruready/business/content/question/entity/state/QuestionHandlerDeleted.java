...
/**
 * The state of a question marked for deletion.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
class QuestionHandlerDeleted extends QuestionHandlerStub
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(QuestionHandlerDeleted.class);
	 ...
	 */
	protected QuestionHandlerDeleted()
	{
		super();
	}
	...
	{
		return QuestionStateID.DELETED;
	}
	...
	public Set<QuestionAction> getActions()
	{
		...
		actions.add(QuestionAction.UNDELETE);
		return actions;
	}
	 ...
	 */
	@Override
	public void undelete(final AbstractQuestionState state)
	{
	...
	public void timeout(final AbstractQuestionState state, final long cutoffTime)
	{
		...
		{
			updateState(state, QuestionStateID.EXPIRED);
		}
	}
