...
/**
 * An institution item representing a city, e.g. Salt Lake City.
 * <p>
 * -------------------------------------------------------------------------<br>
...
public class City extends Item
{
	...
	/**
	 * County that the city resides in.
	 */
	...
	/**
	 * Create a city with a name and comment.
	 * 
	 * @param name
	 *            course name
	 * @param comment
	...
	/**
	 * Set a new value for the county property.
	 * 
	 * @param county
	 *            the county to set
	 */
