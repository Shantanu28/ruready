...
/**
 * A country that has states, e.g. United States.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class Federation extends Country
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	public Federation(String name, String comment, int phoneCode)
	{
		super(name, comment, phoneCode);
	}
