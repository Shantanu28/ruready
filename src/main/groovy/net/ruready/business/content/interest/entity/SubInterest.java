...
/**
 * A catalog item representing a student sub-interest. A leaf in the CMS interest hierarchy.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class SubInterest extends MainTagItem
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public SubInterest(String name, String comment)
	{
		super(name, comment);
	}
