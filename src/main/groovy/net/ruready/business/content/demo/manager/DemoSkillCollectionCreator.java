...
/**
 * A factory of a mock skill collection created for testing and upon site
 * initialization.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Aug 1, 2007
 */
class DemoSkillCollectionCreator implements DemoItemCreator<SkillCollection>
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(DemoSkillCollectionCreator.class);
	 ...
	 * </p>
	 */
	public DemoSkillCollectionCreator()
	{
	 ...
	 */
	public SkillCollection createItem(String uniqueName)
	{
		// Create some items. Because we only add items,
		// the tree automatically refreshes and appears sorted.
		logger.info("Creating base skill collection");
		SkillCollection skillCollection = null;
		Item parent = null;
		Item child = null;

		skillCollection = new SkillCollection(uniqueName, "Math Skills");
		child = skillCollection;

		// =======================================
		// Add some skills
		// =======================================
		String[] skillNames =
		{ "Solving quadratic equation", "Simplifying expressions", "Factoring",
				"Solving Linear equation", "Solving rational equations",
				"Translating a number to a point" };

		parent = child;
		for (String skillName : skillNames)
		{
			child = new Skill(skillName, null);
