...
/**
 * Apply a Hibernate save-and-update operation to all nodes in a tree. Note: treats all
 * tree items as raw Items, not as specific sub-classes (e.g. Question) when saving them.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Aug 11, 2007
 */
public class ApplySaveOrUpdate<B extends Item> extends LimitedDepthTreeVisitor
{
	// ========================= FIELDS =====================================
	 ...
	 *            tree root node
	 */
	private ApplySaveOrUpdate(AbstractEditItemManager<B> manager, Item thisNode)
	{
		super();
	 ...
	 *            tree root node
	 */
	public static <B extends Item> void update(AbstractEditItemManager<B> manager,
			Item thisNode)
	{
		new ApplySaveOrUpdate<B>(manager, thisNode).executeOnTree(thisNode);
	}
	...
	protected Object executePre(Node thisNode)
	{
		...
		manager.update((B) thisNode, false);
		return null;
	}
