/*****************************************************************************************
 * Source File: ApplyRemoveIdentity.java
 ****************************************************************************************/
...
/**
 * Removes the unique identifiers of all nodes in the tree so that it can be saved
 * (created, not updated) in the database using Hibernate.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Aug 11, 2007
 */
public class ApplyRemoveIdentity extends LimitedDepthTreeVisitor
{
	// ========================= FIELDS =====================================

	// DAO to use for saving a single node
	// private AbstractEditItemManager manager;
	 ...
	 *            tree root node
	 */
	private ApplyRemoveIdentity(Node thisNode)
	{
		super();
	}

	/**
	 * A facade to be called instead of constructing this object. Removes the tree nodes'
	 * unique ids.
	 * 
	 * @param thisNode
	 *            tree root node
	 */
	public static void removeIdentity(Node thisNode)
	{
		new ApplyRemoveIdentity(thisNode).executeOnTree(thisNode);
	}
	...
	{
		// Use pre-traversal ordering: remove parent id before children are
		// processed
		thisNode.removeIdentity();
		return null;
	}
