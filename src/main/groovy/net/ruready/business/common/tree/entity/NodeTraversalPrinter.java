...
/**
 * Print a database-persistent tree in pre-traversal ordering.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
class NodeTraversalPrinter implements Printer<Node>, Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(NodeTraversalPrinter.class);
	 ...
	 *            the tree to be printed
	 */
	public NodeTraversalPrinter(Node tree)
	{
		this.tree = tree;
	}
	 ...
	 */
	public NodeTraversalPrinter(Node tree, String openingBracket, String closingBracket,
	 ...
	 */
	public NodeTraversalPrinter(Node newTree, NodeTraversalPrinter other)
	{
		this.tree = newTree;
