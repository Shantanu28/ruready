...
public class DDLFileFixer
{
	...
	private static final Log logger = LogFactory.getLog(DDLFileFixer.class);
	 ...
	 */
	public DDLFileFixer(final String inputFileName, final String outputFileName,
	...
	protected void processLine(String line)
	{
		...
		else if (line.startsWith(CREATE_TABLE_PREFIX))
		{
			...
			tableSQL.append(line.substring(0, index)).append(DDLFileFixer.TABLE_SUFFIX)
	...
	protected void writeOutput()
	{
		try
		{
			...
			writer.write(DDLFileFixer.DROP_DATABASE_STATEMENT(databaseName).toString()
					.getBytes());
