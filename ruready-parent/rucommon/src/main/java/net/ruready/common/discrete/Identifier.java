/*****************************************************************************************
 * Source File: Identifier.java
 ****************************************************************************************/
package net.ruready.common.discrete;

/**
 * Consitutes a unique identifier of an object in a hierarchy of objects inheriting from a
 * common same base class. This allows us to discriminate the concrete object types.
 * <p>
 * -------------------------------------------------------------------------<br>
