...
/*
 * Copyright 2004 The Apache Software Foundation. Licensed under the Apache License,
...
/**
 * Formats a Complex number in cartesian format "Re(c) + Im(c)i". 'i' can be replaced with
 * 'j', and the number format for both real and imaginary parts can be configured.
 * 
 * @author Apache Software Foundation
 * @version $Revision: 348519 $ $Date: 2005-11-23 12:12:18 -0700 (Wed, 23 Nov 2005) $
 *          <p>
 *          Taken from Apache commons math.
 */
public class ComplexFormat extends Format implements Serializable
{
	...
	private static final String DEFAULT_IMAGINARY_CHARACTER = Complex.getUNIT_IM_SYMBOL(); // "i";
	...
	/**
	 * Create an instance with a custom number format for the real part and a custom
	 * number format for the imaginary part.
	 * 
	 * @param realFormat
	...
	/**
	 * Create an instance with a custom imaginary character, a custom number format for
	 * the real part, and a custom number format for the imaginary part.
	 * 
	 * @param imaginaryCharacter
	 *            The custom imaginary character.
	 * @param realFormat
	 ...
	 * @param pos
	 *            On input: an alignment field, if desired. On output: the offsets of the
	 *            alignment field
	 ...
	 * {@link Complex} object or a {@link Number} object. Any other type of object will
	...
	/**
	 * Formats a double value to produce a string. In general, the value is formatted
	 * using the formatting rules of <code>format</code>. There are three exceptions to
	 * this:
	 * <ol>
	...
	/**
	 * Get the set of locales for which complex formats are available. This is the same
	 * set as the {@link NumberFormat} set.
	 * 
	 ...
	 * {@link NumberFormat#getInstance()} with the only customizing is the maximum number
	 * of fraction digits, which is set to 2.
	 * 
	...
	/**
	 * Create a default number format. The default number format is based on
	 * {@link NumberFormat#getInstance(java.util.Locale)} with the only customizing is the
	 ...
	 *            the string to parse
	 * @param pos
	 *            input/ouput parsing parameter. On output, <code>pos</code> holds the
	 *            index of the next non-whitespace character.
	 */
	...
	/**
	 * Parses <code>source</code> for a special double values. These values include
	...
	/**
	 * Parses <code>source</code> for a number. This method can parse normal, numeric
	 * values as well as special values. These special values include Double.NaN,
	 ...
	 * @throws IllegalArgumentException
	 *             if <code>imaginaryCharacter</code> is <code>null</code> or an empty
	 *             string.
	 */
