/*******************************************************
 * Source File: ComponentNode.java
 *******************************************************/
 ...
 * subclasses are <code>CompositeNode</code> and <code>TerminalNode</code>.
 * A composite node contains other nodes, which can be other composites or
...
public abstract class ComponentNode
{
	...
	{
		return toString(0, true, new ArrayList<ComponentNode>());
	}

	/*
	 * Return a textual description of this node, noting whether composite
	 * objects should display their objects, and keeping track of previously
	 * visited nodes. @return a textual description of this node
	 */
	protected abstract String toString(int n, boolean label,
			List<ComponentNode> visited);
	...
	{
		return toString(0, false, new ArrayList<ComponentNode>());
	}
}
