 ...
 * @version Aug 4, 2007
 */
public final class ListTreeNode<D extends Serializable & Comparable<? super D>>
		implements AbstractListTreeNode<D, ListTreeNode<D>>
{
	// ========================= CONSTANTS =================================
	...
	// The parent node
	protected ListTreeNode<D> parent;

	protected List<ListTreeNode<D>> children;

	// Comparator according to which children are sorted
	protected Comparator<? super ListTreeNode<D>> comparator;

	protected Printer<ListTreeNode<D>> printer;
	 ...
	 */
	public ListTreeNode<D> getParent()
	{
		return parent;
	}
	 ...
	 */
	public ListTreeNode<D> getSuperParent(final int height)
	{
		ListTreeNode<D> node = this;
	 ...
	 */
	public List<ListTreeNode<D>> getSiblings()
	{
	 ...
	 * @return the printer
	 */
	public Printer<ListTreeNode<D>> getPrinter()
	{
		return printer;
	}
	 ...
	 *            the printer to set
	 */
	public void setPrinter(Printer<ListTreeNode<D>> printer)
	{
	 ...
	 * @return the children
	 */
	public List<ListTreeNode<D>> getChildren()
	{
		return children;
	}
	 ...
	 */
	public void addChild(ListTreeNode<D> child)
	{
		if (child == this)
		{
			throw new TreeException("Cannot add a node under itself! this = " + this);
		}
		children.add(child);
	 ...
	 */
	public void addChild(int index, ListTreeNode<D> child)
	{
	 ...
	 */
	public ListTreeNode<D> getChild(int index)
	{
	 ...
	 */
	public int indexOf(ListTreeNode<D> child)
	{
	...
	public int indexOf(Long childId)
	{
		...
		// int i = 0;
		// for (ListTreeNode<D> child : children)
		// {
	 ...
	 */
	public void setChildAt(int id, ListTreeNode<D> child)
	{
	 ...
	 *      net.ruready.common.tree.AbstractListTreeNode)
	 */
	public void replaceChild(ListTreeNode<D> oldChild, ListTreeNode<D> newChild)
	{
	 ...
	 */
	public void removeChild(ListTreeNode<D> child)
	{
	 ...
	 */
	public void addChilds(Collection<ListTreeNode<D>> newChildren)
	{
		children.addAll(newChildren);
		for (ListTreeNode<D> child : newChildren)
		{
			child.setParent(this);
		}
		refresh();
	...
	{
		for (ListTreeNode<D> child : getChildren())
		{
			child.setParent(null);
		}
		children = new ArrayList<ListTreeNode<D>>();
	}
	 ...
	 */
	public List<ListTreeNode<D>> toNodeList(final TraversalOrder traversalOrder)
	{
		return new TreeNodeTraverser<D, ListTreeNode<D>>(traversalOrder).traverse(this);
	}
	...
	public ListTreeNode<D> shallowClone()
	{
		...
		ListTreeNode<D> copy = new ListTreeNode<D>((D) GenericCloner.clone(data));
	...
	public void mergeInto(final ShallowCloneable destination)
	{
		...
		// http://www.ibm.com/developerworks/java/library/j-jtp01255.html
		// Hence, we suppress an unchecked warning here.
		ListTreeNode<D> dest = (ListTreeNode<D>) destination;
	...
	@SuppressWarnings("unchecked")
	@Override
	public ListTreeNode<D> clone()
	{
		// try {
		// Copy root node data
		ListTreeNode<D> copy = this.shallowClone();
	...
	private void initialize()
	{
		...
		setPrinter(new TraversalPrinter<D, ListTreeNode<D>>(this));
	 ...
	 */
	private void setParent(ListTreeNode<D> parent)
	{
		// if (parent == null)
		// {
		...
		// ListTreeNode<D> copy = this.clone();
	 ...
	 */
	public Comparator<? super ListTreeNode<D>> getComparator()
	{
		return comparator;
	}
	 ...
	 *            the comparator to set
	 */
	public void setComparator(Comparator<? super ListTreeNode<D>> comparator)
	{
	 ...
	 */
	private void setComparator(Comparator<? super ListTreeNode<D>> comparator,
			boolean doRefresh)
	{
