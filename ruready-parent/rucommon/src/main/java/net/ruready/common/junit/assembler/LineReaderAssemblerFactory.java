 ...
 * @version Sep 8, 2007
 */
public class LineReaderAssemblerFactory implements AbstractAssemblerFactory
{
	// ========================= CONSTRUCTORS ==============================
	 ...
	 */
	public LineReaderAssemblerFactory()
	{
	...
	{
		switch ((LineReaderAssemblerID) identifier)
		{
			/**
			...
			case APPEND_TOKEN:
			{
				return new AppendTokenAssembler();
			}
			...
			case SET_LINE_ID:
			{
				return new SetLineIDAssembler((LineID) args[0]);
			}
