/*****************************************************************************************
 * Source File: HungarianAlgorithm.java
 ****************************************************************************************/
 ...
 * <p>
 * Konstantinos A. Nedas <br>
 * Department of Spatial Information Science & Engineering<br>
 * University of Maine, Orono, ME 04469-5711, USA<br>
 * kostas@spatial.maine.edu<br>
 * http://www.spatial.maine.edu/~kostas<br>
 * <p>
 ...
 * a. A 2-D array (could be rectangular or square).<br>
 * b. A string ("min" or "max") specifying whether you want the min or max
 * assignment.<br>
 * [It returns an assignment matrix[array.length][2] that contains the row and
 * col of the elements (in the original inputted array) that make up the optimum
 * assignment.]
 * <p>
...
public class HungarianAlgorithm
{
	...
	private static final Log logger = LogFactory.getLog(HungarianAlgorithm.class);
	...
	public static int hg_step3(final int previousStep, int[][] mask, int[] colCover)
	{
		...
		for (int i = 0; i < mask.length; i++) // Cover columns of starred
		// zeros.
		{
			for (int j = 0; j < mask[i].length; j++)
			{
	 ...
	 * @return
	 */
	public static int hg_step5(int previousStep, int[][] mask, int[] rowCover,
	 ...
	 * @return
	 */
	public static int hg_step6(int previousStep, double[][] cost, int[] rowCover,
	...
	public static void main(String[] args)
	{
		...
		{
			logger.debug("Array transposed (because rows>columns).\n"); // Cols
			// must
			// be
			// >=
			// Rows.
