...
public class CmdExecUnix extends CmdExec
{
	...
	private static final Log logger = LogFactory.getLog(CmdExecUnix.class);
	...
	/**
	 * Run a command line on Unix/Linux.
	 * 
	 * @param cmdline
	 *            command line
	 * @param outFile
	 ...
	 *            the screen.
	 */
	public CmdExecUnix(String cmdline, String outFile)
	{
		try
		{
			String line;
