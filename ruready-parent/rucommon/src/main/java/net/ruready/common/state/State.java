...
/**
 * A state of a state machine (part of the state pattern).
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
public interface State<ID extends StateID, S extends State<ID, S>> extends
		Identifiable<ID>, Visitable<Visitor<S>>, Subject
{
	// ========================= CONSTANTS =================================
