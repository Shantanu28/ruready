/*****************************************************************************************
 * Source File: SimpleElementHelper.java
 ****************************************************************************************/
...
/**
 * A helper that processes a simple XML tag's body.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 8, 2007
 */
public class StringElementHelper extends GriddyHelper
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(StringElementHelper.class);
	 ...
	 */
	public StringElementHelper(final String tagName)
	{
		super(tagName);
	}
	...
	public void processEndElement(Object target)
	{
		...
		XmlBodyElement element = new XmlBodyElement(tagName, input);
