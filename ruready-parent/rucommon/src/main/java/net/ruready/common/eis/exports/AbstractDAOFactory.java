...
/**
 * An abstract DAO factory that different persistent layers should implement. Also
 * contains utilities provided by the persistent layer.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 31, 2007
 */
public interface AbstractDAOFactory extends Resource<Properties>
{
	// ========================= CONSTANTS =================================
	...
	/**
	 * Produces a DAO class. If a custom DAO class is not found (say) a
