...
/**
 * A catalog item representing a student interest. Contains sub-interests.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class Interest extends MainTagItem
{
	// ========================= CONSTANTS =================================
	 ...
	 *            course comment
	 */
	public Interest(String name, String comment)
	{
		super(name, comment);
	}
