...
/**
 * A catalog item representing a content type in a course, e.g. Expectations, Content
 * Knowledge, Feedback. Each content type represents a subset of topics, sub-topics and
 * questions to be presented in some related tests.
 * <p>
 * Note: we would really like to make this class abstract, but Hibernate has been throwing
 * some weird instantiation exceptions on {@link MainItem}s.Hide the constructors and
 * make the class concrete if this happens.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Entity
public class ContentType extends Item
{
	// ========================= CONSTANTS =================================
	...
	/**
	 * Create a content type with a name and comment.
	 * 
	 * @param name
	 *            course name
	 * @param comment
	 *            course comment
	 */
	protected ContentType(String name, String comment)
	{
		super(name, comment);
	}
