...
public class SearchCriteriaOptions implements Serializable
{
	...
	public SearchCriteriaOptions(final MessageSource messageResources)
	{
	...
	private OptionList getOptionList(final MessageSource messageResources,
			final Class<?> type)
	{
	...
	private <E> OptionList getFilteredOptionList(final MessageSource messageResources,
