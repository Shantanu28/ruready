...
/**
 * A student transcript BD interface with a Struts resource locator.
* <p>
* -------------------------------------------------------------------------<br>
...
* @version Nov 20, 2007
*/
public class StrutsStudentTranscriptBD extends DefaultStudentTranscriptBD
{

	public StrutsStudentTranscriptBD(final ApplicationContext context)
	{
		super(
