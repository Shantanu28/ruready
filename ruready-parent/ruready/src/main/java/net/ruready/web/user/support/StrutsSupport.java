...
/**
 * User management-specific Struts support methods 
* <p>
* -------------------------------------------------------------------------<br>
...
{	
	...
	public final AbstractUserBD getUserBD(final HttpServletRequest request)
	{
		return new StrutsUserBD(getWebApplicationContext(request));
	}
	
	public final AbstractUserGroupBD getUserGroupBD(final HttpServletRequest request)
	{
		return new StrutsUserGroupBD(getWebApplicationContext(request));
	}
	
	public final AbstractWorldBD getWorldBD(final HttpServletRequest request)
	{
		return new StrutsWorldBD(getSystemUser(),getWebApplicationContext(request)); 
	}	
}
