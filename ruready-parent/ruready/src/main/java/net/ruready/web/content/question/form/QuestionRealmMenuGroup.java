 ...
 * from the business layer to an Struts AJAX action. It is used on the search
 * question page.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Nov 7, 2007
 */
public class QuestionRealmMenuGroup extends ItemMenuGroup
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(QuestionRealmMenuGroup.class);

	/**
	 * Course menu properties.
	 */
	private static final MenuProperties<ItemType, Item> subjectMenu = new MenuProperties<ItemType, Item>(
			ItemType.SUBJECT, true, WebAppNames.KEY.MESSAGE.OLS_ANY_LABEL,
			Subject.class, ItemType.CATALOG);

	/**
	 * Course menu properties.
	 */
	private static final MenuProperties<ItemType, Item> courseMenu = new MenuProperties<ItemType, Item>(
			ItemType.COURSE, false, WebAppNames.KEY.MESSAGE.OLS_ANY_LABEL);

	/**
	 * Topic menu properties.
	 */
	private static final MenuProperties<ItemType, Item> topicMenu = new MenuProperties<ItemType, Item>(
			ItemType.TOPIC, false, WebAppNames.KEY.MESSAGE.OLS_ANY_LABEL);

	/**
	 * Sub-topic menu properties.
	 */
	private static final MenuProperties<ItemType, Item> subTopicMenu = new MenuProperties<ItemType, Item>(
			ItemType.SUB_TOPIC, false, WebAppNames.KEY.MESSAGE.OLS_ANY_LABEL);
	...
	public QuestionRealmMenuGroup(final ApplicationContext context, final User user)
	{
		super(context, user, subjectMenu, courseMenu, topicMenu, subTopicMenu);
	}
}
