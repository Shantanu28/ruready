...
public class UserDemographicOptions implements Serializable
{
	...
	public UserDemographicOptions(final MessageSource messageResources)
	{
		this (messageResources, false);
	}
	
	public UserDemographicOptions(final MessageSource messageResources, final Boolean required)
	{
	...
	private OptionList getOptionList(final MessageSource messageResources, final Class<?> type, final Boolean required)
	{
