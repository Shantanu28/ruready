...
/**
 * This command closes a Hibernate session.
 * <p>
 * -------------------------------------------------------------------------<br>
...
public class CloseSessionCommand extends BaseCommand
{
	...
	{
		return "Close session [Safe Mode]";
	}
}
