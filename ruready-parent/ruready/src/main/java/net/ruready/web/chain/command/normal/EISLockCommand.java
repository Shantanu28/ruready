...
/**
 * This command locks subsequent EIS transaction to be read-only.
 * <p>
 * -------------------------------------------------------------------------<br>
...
public class EISLockCommand extends BaseCommand
{
	// ========================= IMPLEEMNTATION: BaseActionCommand =========

	/**
	 * Locks subsequent EIS transaction to be read-only.
	 * 
	 * @param arg0
	 * @return
	 * @throws Exception
