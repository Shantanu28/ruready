...
public class UtcDateTimeType implements UserType
{
    ...
    @Override
    public Object nullSafeGet(ResultSet rs, String[] strings, SessionImplementor si, Object owner) throws HibernateException, SQLException {
        String value = (String) StringType.INSTANCE.nullSafeGet(rs, strings[0], si, owner);
    ...
    public void nullSafeSet(PreparedStatement ps, Object value, int index, SessionImplementor si) throws HibernateException, SQLException {
        StringType.INSTANCE.nullSafeSet(ps, (value != null) ? value.toString() : null, index, si); 
    }
}
