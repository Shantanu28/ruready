...
/**
 * Pop two numbers from the stack and push the result of their logical relation
 * (and,or,assigned-to,equals, etc.).
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 8, 2007
 */
class RelationAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	 ...
	 * push a new <code>SyntaxTreeNode</code> on the assembly's stack.
	 * 
	 * @param a
