/*******************************************************
 * Source File: ElementMarkerProcessor.java
 *******************************************************/
...
/**
 * A prepared parser processing chain that runs the element marker on a pair of
 ...
 * @version Apr 17, 2007
 */
public class ElementMarkerProcessor extends RequestHandlerChain implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(ElementMarkerProcessor.class);
	 ...
	 */
	public ElementMarkerProcessor(RequestHandler nextNode)
	{
		super(null, nextNode);
		...
		tempList.add(new MarkerHandler(AnalysisID.ELEMENT,
				ParserNames.REQUEST.ATTRIBUTE.MARKER.ELEMENTS_RESULT));
