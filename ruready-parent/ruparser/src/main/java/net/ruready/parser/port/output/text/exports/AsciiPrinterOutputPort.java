/*******************************************************
 * Source File: AsciiPrinterOutputPort.java
 *******************************************************/
...
import net.ruready.parser.port.output.text.manager.AsciiPrinter;
 ...
 * @version Apr 16, 2007
 */
public class AsciiPrinterOutputPort extends PrinterOutputPort
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(AsciiPrinterOutputPort.class);
	 ...
	 */
	public AsciiPrinterOutputPort(String attributeNameTarget, String attributeNameOutput)
	{
	...
	{
		return ParserNames.HANDLER.PORT.OUTPUT + CommonNames.MISC.TAB_CHAR + "ASCII string";
	}
	...
	{
		printer = new AsciiPrinter(target, this.getOptions());
	}
}
