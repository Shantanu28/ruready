...
/**
 * An assembler for the symbol of a logical relational operation. (e.g., "=", "<=", ...).
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 19, 2007
 */
class RelationOperationSymbolAssembler extends Assembler
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(RelationOperationSymbolAssembler.class);
