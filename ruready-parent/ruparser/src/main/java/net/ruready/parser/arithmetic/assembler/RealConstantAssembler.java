 ...
 * @version Sep 8, 2007
 */
class RealConstantAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	 ...
	 */
	public RealConstantAssembler(final RealConstant realConstant)
	{
		super();
	...
	public void workOn(Assembly a)
	{
		...
		if (target.getArithmeticMode().compareTo(ArithmeticMode.REAL) < 0)
		{
			// Real arithmetic mode was turned off, so this expression is
			// illegal.
			target.addSyntaxError(new InternationalizableErrorMessage(
					"Real arithmetic mode is turned off",
					ParserNames.KEY.MATH_EXCEPTION.REAL_CONSTANT,
