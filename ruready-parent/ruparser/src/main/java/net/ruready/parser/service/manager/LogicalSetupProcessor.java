...
import net.ruready.parser.logical.exports.LogicalCompilerHandler;
 ...
 * logical matching. Constructs the logical compiler.
 * 
 ...
 * @version Apr 17, 2007
 */
public class LogicalSetupProcessor extends RequestHandlerChain
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(LogicalSetupProcessor.class);
	...
	static {
		...
		tempList.add(new LogicalCompilerHandler());
	...
	/**
	 * Create a stand-alone logical grammar matching processor.
	 */
	public LogicalSetupProcessor()
	{
	 ...
	 */
	public LogicalSetupProcessor(RequestHandler nextNode)
	{
