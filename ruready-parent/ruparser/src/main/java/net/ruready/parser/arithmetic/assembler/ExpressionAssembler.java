...
/**
 * An assembler for post-processing, at the end of an arithmetic expression matching.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Aug 16, 2007
 */
class ExpressionAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	public void workOn(Assembly a)
	{
		...
		// logger.debug("target " + target.toStringDetailed());
