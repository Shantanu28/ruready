...
import net.ruready.parser.param.exports.ParametricEvaluationMatcherHandler;
...
/**
 * Performs a parametric evaluation of a string. Assumes parametric evaluation
 ...
 * @version Apr 17, 2007
 */
public class ParametricEvaluationProcessor extends RequestHandlerChain
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(ParametricEvaluationProcessor.class);
	...
	static {
		...
		tempList.add(new ParametricEvaluationMatcherHandler());
	 ...
	 */
	public ParametricEvaluationProcessor(RequestHandler nextNode)
	{
