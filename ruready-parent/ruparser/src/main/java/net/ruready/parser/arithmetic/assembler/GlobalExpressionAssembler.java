/*****************************************************************************************
 * Source File: GlobalExpressionAssembler.java
 ****************************************************************************************/
...
/**
 * An assembler for post-processing, at the end of [controlled] arithmetic expression
 * matching. Removes the fictitious root node from the syntax tree.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 */
@Deprecated
class GlobalExpressionAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(GlobalExpressionAssembler.class);
	...
	public void workOn(Assembly a)
	{
		...
		// Remove fictitious root node (replace root node by first child;
		// there's supposed to be one child anyway) and push target back onto
		// stack
		target.replaceRootNodeByChild();
		// a.push(target);
