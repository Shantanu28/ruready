 ...
 * @version Sep 8, 2007
 */
class BinaryFunctionAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	/**
	 * A dummy number. should belong to all supported NumericalValue fields.
	 */
	...
	public void workOn(Assembly a)
	{
		...
		try
		{
			BinaryValue op = (BinaryFunction) t.getValue();
