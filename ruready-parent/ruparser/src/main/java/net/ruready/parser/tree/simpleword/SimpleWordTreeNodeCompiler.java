/*******************************************************************************
 * Source File: SimpleWordTreeNodeCompiler.java
 ******************************************************************************/
 ...
 * @version May 28, 2007
 */
class SimpleWordTreeNodeCompiler extends
		AbstractTreeNodeCompiler<String, ListTreeNode<String>>
{
	...
	private static final Log logger =
			LogFactory.getLog(SimpleWordTreeNodeCompiler.class);
	 ...
	 */
	public SimpleWordTreeNodeCompiler(
	/* ParserOptions options, */)
	{
		super(new SimpleWordTreeNodeDataCompiler().parser(),
				new DataAssembler(), new ExpressionAssembler());
	}
