...
import net.ruready.parser.param.exports.ParametricEvaluationCompilerHandler;
 ...
 * parametric evaluation. Constructs the parametric evaluation compiler.
 * 
 ...
 * @version Apr 17, 2007
 */
public class ParametricEvaluationSetupProcessor extends RequestHandlerChain
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(ParametricEvaluationSetupProcessor.class);
	...
	static {
		...
		tempList.add(new ParametricEvaluationCompilerHandler());
	 ...
	 */
	public ParametricEvaluationSetupProcessor()
	{
	 ...
	 */
	public ParametricEvaluationSetupProcessor(RequestHandler nextNode)
	{
