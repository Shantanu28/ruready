/*******************************************************************************
 * Source File: SyntaxTreeNodeCompiler.java
 ******************************************************************************/
 ...
 * @version May 28, 2007
 */
class SyntaxTreeNodeCompiler extends
		AbstractTreeNodeCompiler<MathToken, SyntaxTreeNode>
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger =
			LogFactory.getLog(SyntaxTreeNodeCompiler.class);
	 ...
	 */
	public SyntaxTreeNodeCompiler(
	/* ParserOptions options, */)
	{
		super(new SyntaxTreeNodeDataCompiler().parser(), new DataAssembler(),
