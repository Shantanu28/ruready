 ...
 * pair of strings and generates an analysis object and an HTML string.
 * 
 ...
 * @version Apr 17, 2007
 */
class MathParserDemoService extends RequestHandlerChain implements ParserService
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(MathParserDemoService.class);
	 ...
	 */
	public MathParserDemoService(final String referenceString,
			...
			RequestHandler nextNode)
	{
		...
		// Generic marker handler
		// tempList.add(new ATPMEditDistanceHandler(null));
	...
	{
		return ParserServiceID.MATH_DEMO;
	}
