/*******************************************************
 * Source File: ATPMAnalysisLoop.java
 *******************************************************/
...
import net.ruready.common.chain.RequestHandlerLoop;
import net.ruready.common.rl.CommonNames;
import net.ruready.parser.analysis.manager.RCEndLoop;
import net.ruready.parser.analysis.manager.RCStartLoop;
 ...
 * @version Jun 12, 2007
 */
public class ATPMAnalysisLoop extends RequestHandlerLoop
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(ATPMAnalysisLoop.class);
	 ...
	 */
	public ATPMAnalysisLoop(RequestHandler nextNode)
	{
		super(null, null, null, nextNode);
		...
		RequestHandler start = new RCStartLoop(null);
		...
		RequestHandler[] bodyList = tempList.toArray(new RequestHandler[tempList.size()]);

		RequestHandler end = new RCEndLoop(null);

		this.initialize(start, bodyList, end, nextNode);
	}
