/*******************************************************
 * Source File: Binary2MultinaryConverterHandler.java
 *******************************************************/
package net.ruready.parser.absolute.exports;

import net.ruready.common.chain.RequestHandler;
import net.ruready.parser.absolute.manager.AbsoluteCanonicalizer;
import net.ruready.parser.absolute.manager.Binary2MultinaryConverter;
 ...
 * @version Apr 16, 2007
 */
public class Binary2MultinaryConverterHandler extends AbsoluteCanonicalizationStepHandler
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(Binary2MultinaryConverterHandler.class);
	 ...
	 * @param nextNode
	 */
	public Binary2MultinaryConverterHandler(String attributeNameTarget,
			RequestHandler nextNode)
	{
		super(attributeNameTarget,
				ParserNames.ABSOLUTE_CANONICALIZATION.BINARY2MULTINARY, nextNode);
	}
	...
	public Binary2MultinaryConverterHandler(String attributeNameTarget)
	{
		super(attributeNameTarget, ParserNames.ABSOLUTE_CANONICALIZATION.BINARY2MULTINARY);
	}
	...
	protected void processTarget(MathTarget target)
	{
		...
		AbsoluteCanonicalizer canonicalizer = new Binary2MultinaryConverter(target);
