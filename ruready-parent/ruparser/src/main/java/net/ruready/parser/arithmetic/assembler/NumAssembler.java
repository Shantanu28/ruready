...
/**
 * An assembler assigned to {@link Num} tokens (numbers) of a logical expression.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 8, 2007
 */
class NumAssembler extends Assembler implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	public void workOn(Assembly a)
	{
		...
		SyntaxTreeNode e = new SyntaxTreeNode(t);
		a.push(e);
	}
