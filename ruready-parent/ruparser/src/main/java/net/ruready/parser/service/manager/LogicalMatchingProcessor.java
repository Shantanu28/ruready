...
/**
 * A prepared parser processing chain that tokenizes and runs logical matching
 * on a string. Assumes that an logical compiler already exists in the request.
 * 
 ...
 * @version Apr 17, 2007
 */
public class LogicalMatchingProcessor extends RequestHandlerChain
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(LogicalMatchingProcessor.class);
	...
	/**
	 * Create an logical grammar matching processor with a <code>null</code>.
	 */
	public LogicalMatchingProcessor()
	{
		super(specificHandlerList, null);
	}

	/**
	 * Create an logical grammar matching processor.
	 * 
	 * @param nextNode
	 ...
	 */
	public LogicalMatchingProcessor(RequestHandler nextNode)
	{
