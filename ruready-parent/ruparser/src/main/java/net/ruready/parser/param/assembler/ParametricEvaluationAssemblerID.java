 ...
 * @version Sep 8, 2007
 */
public enum ParametricEvaluationAssemblerID implements AssemblerIdentifier
{
	// ========================= ENUMERATED TYPES ==========================
	...
	/**
	 * Evaluates a mathematical expression using the mathematical parser and appends the
	 * result to the evaluated string.
	 */
