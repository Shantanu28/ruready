...
/**
 * Pop a token from the stack and push the corresponding mathematical complex constant
 ...
 * @version Sep 8, 2007
 */
class ComplexConstantAssembler extends Assembler
{
	// ========================= CONSTANTS =================================
	...
	public void workOn(Assembly a)
	{
		...
		// ParserNames.KEY.MATH_EXCEPTION.COMPLEX_CONSTANT, true,
		// complexConstant.toString(), target.getArithmeticMode().toString()));
		// }
		// else {
		...
		// value);
		// StringBuffer e =
		// ConversionUtil.generateVariableElement(mt.getValue().toString());
		// MathToken mt = new MathToken(((MathAssembly) a).elementsConsumedAll()
		// - 1,
		// value);
		StringBuffer e = ConversionUtil.generateComplexConstantElement(complexConstant);
