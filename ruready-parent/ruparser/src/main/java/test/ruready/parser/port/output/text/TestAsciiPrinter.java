/*****************************************************************************************
 * Source File: TestAsciiPrinter.java
 ****************************************************************************************/
...
/**
 * Test the HTML printer (with element marker highlighter as an example), and
 * its generated highlights.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 26, 2007
 */
public class TestAsciiPrinter extends TestBase
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(TestAsciiPrinter.class);
	...
	public void testFromFile()
	{
		...
		TestFileReader t = new TestAsciiPrinterFromFile(
				TestingNames.FILE.PARSER.PORT.OUTPUT.ASCII_PRINTER, options);
		t.test();
