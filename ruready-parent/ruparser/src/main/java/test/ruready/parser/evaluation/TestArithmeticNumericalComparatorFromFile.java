...
/**
 * Reads and runs arithmetic math expression numerical comparison tests from a file.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Jul 16, 2007
 */
class TestArithmeticNumericalComparatorFromFile extends TestFileReader implements
		Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(TestArithmeticNumericalComparatorFromFile.class);
	 ...
	 */
	public TestArithmeticNumericalComparatorFromFile(String fileName,
