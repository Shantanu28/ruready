/*******************************************************************************
 * Source File: TestUnary2MultinaryConverterFromFile.java
 ******************************************************************************/
...
/**
 * Reads and runs tests of unary-to-multi-nary operation conversion from a data
 * file.
 * 
 ...
 * @version Jun 4, 2007
 */
class TestUnary2MultinaryConverterFromFile extends
		TestAbsoluteCanonicalizationStepFromFile
{
	...
	private static final Log logger = LogFactory
			.getLog(TestUnary2MultinaryConverterFromFile.class);
	 ...
	 */
	public TestUnary2MultinaryConverterFromFile(String fileName,
