/*****************************************************************************************
 * Source File: TestMathParserDemoProcessor.java
 ****************************************************************************************/
 ...
 * @version Aug 15, 2007
 */
public class TestMathParserDemoProcessor extends TestBase
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(TestMathParserDemoProcessor.class);
	...
	public void testFromFile()
	{
		...
		TestFileReader t = new TestMathParserDemoProcessorFromFile(
				TestingNames.FILE.PARSER.EXPORTS.MATH_PARSER_PROCESSOR, options);
		t.test();
