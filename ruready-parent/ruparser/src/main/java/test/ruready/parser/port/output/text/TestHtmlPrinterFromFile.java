/*****************************************************************************************
 * Source File: TestHtmlPrinterFromFile.java
 ****************************************************************************************/
...
/**
 * Reads and runs HTML printer tests from a file.
 * 
...
class TestHtmlPrinterFromFile extends TestFileReader
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(TestHtmlPrinterFromFile.class);
	...
	private class TestResult
	{
		...
		public boolean equals(Object obj)
		{
			...
			if (HTMLString == null)
			{
				if (other.HTMLString != null)
					return false;
			}
			else if (!HTMLString.equals(other.HTMLString))
				return false;
			return true;
		}
	 ...
	 */
	public TestHtmlPrinterFromFile(String fileName, ParserOptions options)
			throws ApplicationException
	{
		super(fileName);
	...
	/**
	 * Test the HTML printer on an input string. The string is matched and absolutely
	 * canonicalized.
	 * 
	 * @param inputStr
	 *            input string
	...
	private void runTest(String inputStr)
	{
		...
		String outputAttribute = ParserNames.REQUEST.ATTRIBUTE.PORT.OUTPUT.HTML.STRING;
		RequestHandler tp4 = new HtmlPrinterOutputPort(
		...
		actualResult.HTMLString = ((OutputStream) request.getAttribute(outputAttribute))
				.toString();
	}
	...
	{
		expectedResult.HTMLString = outputStr.trim();
	}
