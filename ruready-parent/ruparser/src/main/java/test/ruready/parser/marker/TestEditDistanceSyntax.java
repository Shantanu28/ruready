/*****************************************************************************************
 * Source File: TestEditDistanceSyntax.java
 ****************************************************************************************/
 ...
 * @version Sep 26, 2007
 */
public class TestEditDistanceSyntax extends TestBase implements Auxiliary
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(TestEditDistanceSyntax.class);
	...
	public void testFromFile()
	{
		...
		TestFileReader t = new TestEditDistanceSyntaxFromFile(
				TestingNames.FILE.PARSER.ATPM.EDIT_DISTANCE_SYNTAX, options);
		t.test();
