/*****************************************************************************************
 * Source File: TestTreeCommutativeDepth.java
 ****************************************************************************************/
...
/**
 * Reads and runs tests of unary - / binary *,/ switch from file.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 26, 2007
 */
public class TestTreeCommutativeDepth extends TestBase
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory
			.getLog(TestTreeCommutativeDepth.class);
	...
	public void testFromFile()
	{
		...
		TestFileReader t = new TestTreeCommutativeDepthFromFile(
				TestingNames.FILE.PARSER.RELATIVE.TREE_COMMUTATIVE_DEPTH,
				options);
		t.test();
