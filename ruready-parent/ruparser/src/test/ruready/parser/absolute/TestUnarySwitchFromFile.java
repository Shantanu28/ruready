 ...
 * @version Jul 19, 2007
 */
class TestUnarySwitchFromFile extends TestAbsoluteCanonicalizationStepFromFile
{
	// ========================= CONSTANTS =================================
	...
	private static final Log logger = LogFactory.getLog(TestUnarySwitchFromFile.class);
	 ...
	 */
	public TestUnarySwitchFromFile(String fileName, ParserOptions options)
			throws ApplicationException
	{
	...
	protected void runTest(TestInput aTestInput)
	{
		...
		// Run arithmetic matching and then absolute canonicalization on the
		// request
		RequestHandler tp2 = new UnarySwitchHandler(
