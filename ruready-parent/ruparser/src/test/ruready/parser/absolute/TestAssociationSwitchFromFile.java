/*****************************************************************************************
 * Source File: TestAssociationSwitchFromFile.java
 ****************************************************************************************/
...
/**
 * Reads and runs tests of the association switch AC step from a data file.
 * <p>
 * -------------------------------------------------------------------------<br>
 ...
 * @version Sep 8, 2007
 */
class TestAssociationSwitchFromFile extends TestAbsoluteCanonicalizationStepFromFile
		implements Auxiliary
{
	...
	private static final Log logger =
			LogFactory.getLog(TestAssociationSwitchFromFile.class);
	 ...
	 */
	public TestAssociationSwitchFromFile(String fileName, ParserOptions options)
			throws ApplicationException
	{
	...
	protected void runTest(TestInput aTestInput)
	{
		...
		// Run the AC step
		RequestHandler rh0 = new AssociationSwitchHandler(attributeNameTarget);
		rh0.run(request);
